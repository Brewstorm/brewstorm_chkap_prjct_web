...
(function (CheckAppWeb) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return CheckAppWeb.LanguageList.getValue();
            };
    ...
    })(Northwind = CheckAppWeb.Northwind || (CheckAppWeb.Northwind = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Northwind;
    (function (Northwind) {
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(CheckAppWeb.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(CheckAppWeb.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (CheckAppWeb) {
    ...
    })(Common = CheckAppWeb.Common || (CheckAppWeb.Common = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
...
(function (CheckAppWeb) {
    ...
    (function (Northwind) {
        ...
        }(CheckAppWeb.Common.GridEditorDialog));
...
(function (CheckAppWeb) {
    ...
    (function (Northwind) {
        ...
        }(CheckAppWeb.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new CheckAppWeb.BasicProgressDialog();
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(CheckAppWeb.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = CheckAppWeb.BasicSamples || (CheckAppWeb.BasicSamples = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(CheckAppWeb.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: CheckAppWeb.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                CheckAppWeb.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (CheckAppWeb) {
    ...
    })(Membership = CheckAppWeb.Membership || (CheckAppWeb.Membership = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Membership;
...
(function (CheckAppWeb) {
    ...
    })(ScriptInitialization = CheckAppWeb.ScriptInitialization || (CheckAppWeb.ScriptInitialization = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Common;
...
(function (CheckAppWeb) {
    ...
    })(Administration = CheckAppWeb.Administration || (CheckAppWeb.Administration = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Administration;
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return CheckAppWeb.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = CheckAppWeb.BasicSamples || (CheckAppWeb.BasicSamples = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
...
(function (CheckAppWeb) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'CheckAppWeb.Northwind.Entities.Gender');
    })(Northwind = CheckAppWeb.Northwind || (CheckAppWeb.Northwind = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
...
(function (CheckAppWeb) {
    ...
    CheckAppWeb.BasicProgressDialog = BasicProgressDialog;
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var DialogUtils;
    ...
    })(DialogUtils = CheckAppWeb.DialogUtils || (CheckAppWeb.DialogUtils = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Common;
...
(function (CheckAppWeb) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = CheckAppWeb.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = CheckAppWeb.LanguageList || (CheckAppWeb.LanguageList = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Common;
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return CheckAppWeb.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return CheckAppWeb.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return CheckAppWeb.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(CheckAppWeb.Northwind.ProductGrid));
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = CheckAppWeb.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(CheckAppWeb.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new CheckAppWeb.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new CheckAppWeb.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new CheckAppWeb.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, CheckAppWeb.Northwind.OrderRow.Fields.ShipCountry);
        ...
        }(CheckAppWeb.Northwind.OrderGrid));
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return CheckAppWeb.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return CheckAppWeb.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return CheckAppWeb.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return CheckAppWeb.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = CheckAppWeb.Northwind.ProductRow.Fields;
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(CheckAppWeb.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return CheckAppWeb.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(CheckAppWeb.Northwind.OrderDetailsEditor));
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return CheckAppWeb.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return CheckAppWeb.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return CheckAppWeb.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return CheckAppWeb.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new CheckAppWeb.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = CheckAppWeb.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(CheckAppWeb.Northwind.OrderDetailDialog));
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return CheckAppWeb.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return CheckAppWeb.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return CheckAppWeb.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return CheckAppWeb.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return CheckAppWeb.Northwind.OrderService.baseUrl; };
...
(function (CheckAppWeb) {
    ...
    (function (BasicSamples) {
        ...
        }(CheckAppWeb.Northwind.OrderDialog));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: CheckAppWeb.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: CheckAppWeb.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new CheckAppWeb.Northwind.OrderDialog();
                        ...
                        var chai = CheckAppWeb.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = CheckAppWeb.Northwind.EmployeeRow.getLookup().items
...
(function (CheckAppWeb) {
    ...
    })(Authorization = CheckAppWeb.Authorization || (CheckAppWeb.Authorization = {}));
})(CheckAppWeb || (CheckAppWeb = {}));
var CheckAppWeb;
(function (CheckAppWeb) {
    var Administration;
...
//# sourceMappingURL=CheckAppWeb.Web.js.map